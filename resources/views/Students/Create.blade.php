...
<div class="col-md-12">
  ...
  @endif
<form method="POST" enctype="multipart/form-data" action="{{ route('Students.store') }}" role="form" style="width: 80%;margin: 0 auto;background-color: white">
  @csrf
    <div class="card-body">
      ...
      <div class="form-group">
        ...
        <input autofocus type="text" name="nutionalID" class="form-control" id="nutionalID"  value="{{ old('nutionalID') }}">
        @error('nutionalID')
        <span style="color: red">{{ $message }}</span> 
     @enderror
      </div>
      <div class="form-group">
        ...
        <input autofocus type="text" name="phones" class="form-control" id="phones"  value="{{ old('phones') }}">
        @error('phones')
        <span style="color: red">{{ $message }}</span> 
     @enderror
      </div>
